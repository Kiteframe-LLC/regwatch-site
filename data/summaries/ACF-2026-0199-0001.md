# Public Summary: ACF-2026-0199-0001
...
Potential sponsors and adult household members; unaccompanied children in ORR custody; ORR caseworkers and contractors; identity, background-check, and document-verification systems; and organizations assisting sponsors.
...
- **Section:** Authority and Background
  
  **Quote:** The notice describes prior policy-guide requirements and litigation concerning proof of identity and proof of income.
- **Section:** Executive Summary
  
  **Quote:** The NPRM proposes several new requirements, but the prepared record does not fully quantify how each one addresses a documented failure.
- **Section:** Discussion of Elements
  
  **Quote:** The available text does not fully compare tiered documentation, equivalent evidence, or independent review alternatives.
- **Section:** Regulatory Impact Analysis
  
  **Quote:** The notice does not fully quantify processing delays, staffing needs, false positives, or exclusion effects from the added checks.
- **Section:** Authority and Background
  
  **Quote:** The notice relies on investigations and oversight reports whose underlying materials were not supplied in the prepared export.
- **Section:** Proof of Identity and Income
  
  **Quote:** The proposed list of acceptable documents and proof-of-income requirement may exclude suitable sponsors whose records are nonstandard without a fully developed alternative pathway.
- **Section:** Proof of Income
  
  **Quote:** The available record does not explain in sufficient detail how informal workers, recent arrivals, or sponsors with nontraditional household support will be treated.
- **Section:** Regulatory Analyses
  
  **Quote:** The available text does not quantify effects on organizations and service providers that assist sponsors.
- **Section:** Discussion of Elements
  
  **Quote:** The available record does not specify service standards or detailed procedures for conflicting, missing, or foreign documents.
- **Section:** Examinations of UAC
  
  **Quote:** The available record does not fully define how visible markings are documented, corroborated, and weighed in an individualized assessment.
